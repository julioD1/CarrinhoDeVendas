...
public class VendaTest extends TestHeranca {
	...
	@Before
	public void setup() {
		c1 = new Cliente("34125365474", "Lucas@gmail", "Rua 1", "Cliente 1",
				new Date());
		c2 = new Cliente("34125365474", "Tulio@gmail", "Rua 2", "Cliente 2",
				new Date());
		c3 = new Cliente("34125365474", "Vanessa@gmail", "Rua 3", "Cliente 3",
				new Date());
